...
const oddFiltration = (arr) => {
    ...
    let filterArr= arr.filter(ele=> {return ele%2==1;})
    return filterArr;
}
// -------------------------------------------------------------------------------------------------------
...
const cvsFiltration = (arr) => {
    ...
    let filterArr = arr.filter(ele=> { 
        ...
        newArr.push({fullName:`${filterArr[i].firstName} ${filterArr[i].LastName}`
                , tech: filterArr[i].tech})}
...
const vowelsFiltration = (arr) => {
    // write your code here
    let filterArr = arr.filter(ele=>{ return !/[aeiou]/.test(ele);})
    return filterArr;
}
// -------------------------------------------------------------------------------------------------------
