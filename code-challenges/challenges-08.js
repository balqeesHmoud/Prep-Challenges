...
const customerAndAge = (obj) => {
  let result = [];
  for (const [customer, age] of Object.entries(obj)) {
    const customerString = `Customer Name :${customer} , Age :${age}`;
    result.push(customerString);
  }
  return result;
};
// -------------------------------------------------------------------------------------------------------
...
const getEntries = (obj) => {
  ...
  for (const [key, value] of Object.entries(obj)) {
    ...
    const entryString = `${key}: ${formattedValue}`;
    result.push(entryString);
  }
